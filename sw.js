const CACHE="spend-tracker-v21-02-structural";
const ASSETS=["./","./index.html","./manifest.webmanifest","./icons/icon-192.svg","./icons/icon-512.svg","./styles.css","./assets/app-legacy.js","./assets/v21.js","./src/features/fun-library.js"];
